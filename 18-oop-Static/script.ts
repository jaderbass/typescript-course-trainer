class Point2D {
    protected _xPos: number; // ohne weitere Angabe sind Eigenschften immer public
    protected _yPos: number;

    // Statische Eigenschaften sind NUR über die Klasse zugänglich
    public static NUM_DIMENSION = 2;
...
p1.xPos = 4;
console.log(p1);
console.log(Point2D.NUM_DIMENSION);

const p2 = new Point3D(0, 0, 0);
console.log(p2);
// p2.zPos = 8;
console.log(p2);
console.log(Point3D.NUM_DIMENSION);
